...
namespace WXLogic
{
    public class WXWATTTFmu: WXWATProbeTestData
    {
        public static List<WXWATTTFmu> GetmuData(List<WXSpecBinPassFail> fitspec, string rp, List<WXWATProbeTestDataFiltered> filterdata, List<WXWATTTFuse> ttfuse, List<WXWATTTFfit> ttffit)
        {
