...
{
    public class WXWATTTFTerms
    {
        public static List<WXWATTTFTerms> GetTTRTermsData(List<WXWATTTFSorted> srcdata)
        {
            var binpndict = new Dictionary<string, List<WXWATTTFSorted>>();
            ...
            var ret = new List<WXWATTTFTerms>();
            foreach (var kv in binpndict)
            {
                var tempvm = new WXWATTTFTerms();
