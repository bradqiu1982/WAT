...
namespace WAT.Models
{
    public class WXWATPassFailCoupon
    {
        ...
        public static List<WXWATPassFailCoupon> GetPFCouponData(List<WXWATPassFailUnit> srcdatalist, WXSpecBinPassFail minDutSpec)
        {
            ...
            {
                var tempvm = new WXWATPassFailCoupon();
        ...
        public static string GetFailString(List<WXWATPassFailCoupon> srcdata)
        {
        ...
        public static int GetDutCount(List<WXWATPassFailCoupon> srcdata)
        {
            if (srcdata.Count == 0)
            { return 0; }
        ...
        public static int GetSumFails(List<WXWATPassFailCoupon> srcdata)
        {
            if (srcdata.Count == 0)
            { return 0; }
