...
{
    public class WATCouponStats : WATProbeTestDataFiltered
    {
        public static List<WATCouponStats> GetCouponData(List<WATProbeTestDataFiltered> srcdatalist, Dictionary<string, bool> binpndict)
        {
            var ret = new List<WATCouponStats>();
            var paramdict = new Dictionary<string, List<WATProbeTestDataFiltered>>();
            ...
            foreach (var fitem in srcdatalist)
            {
                ...
                {
                    ret.Add(new WATCouponStats(fitem, binpndict, paramnewdict[fitem.CommonTestName]));
                }
            }
        ...
        private static Dictionary<string, string> CouponVal(string param, List<WATProbeTestDataFiltered> oneparamvals)
        {
        ...
        private WATCouponStats(WATProbeTestDataFiltered data,Dictionary<string,bool> binpndict,Dictionary<string,string> cpdict)
        {
