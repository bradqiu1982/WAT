...
namespace WAT.Models
{
    public class WATCPK
    {
        public static List<WATCPK> GetCPK(string RP,List<WATCouponStats> coupondata,List<WATProbeTestDataFiltered> filterdata,List<SpecBinPassFail> cpkspec) {
            var RPStr = "_RP" + (100 + Convert.ToInt32(RP)).ToString().Substring(1);

            var meandict = new Dictionary<string, WATCPK>();
            var stddevdict = new Dictionary<string, WATCPK>();
